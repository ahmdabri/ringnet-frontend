...
export function DocumentCategoryPage() {
  ...
  const [deleteConfirm, setDeleteConfirm] = useState<DocumentCategoryRow | null>(null);
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      setToast(getErrorMessage(err, "Gagal menyimpan kategori."));
    }
  }

  function confirmDelete(row: DocumentCategoryRow) {
  ...
  async function executeDelete() {
    ...
    try {
      ...
      setToast(getErrorMessage(err, "Gagal menghapus kategori."));
    }
    setDeleteConfirm(null);
  }

  function handleEdit(row: DocumentCategoryRow) {
