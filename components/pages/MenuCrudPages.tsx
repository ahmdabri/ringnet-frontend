                  ...
                  {editingTaxKey === item.key ? (
                    <div className="flex items-center gap-1">
                      ...
                      <button
                        ...
                        title="Batal"
                        aria-label="Batal edit nilai pajak"
                      >
                        <X size={17} />
                      </button>
                    </div>
            ...
            <div className="border-b border-dashed border-slate-300 pb-10">
              <div className="mb-4 flex items-center justify-between">
                ...
                <button
                  ...
                  className="grid h-9 w-9 place-items-center rounded-lg text-slate-500 transition hover:bg-slate-100 hover:text-indigo-600"
                  title="Edit logo"
                  aria-label="Edit logo perusahaan"
                >
                  <Edit3 size={18} />
                </button>
              </div>
              ...
              {editingKey === "company_logo_url" ? (
                <div className="mx-auto mt-5 flex max-w-2xl gap-2">
                  <input
                    ...
                    autoFocus
                  />
                  <button type="button" onClick={() => saveProfileValue(logoItem, draft)} className="grid h-11 w-11 place-items-center rounded-lg bg-emerald-50 text-emerald-600" aria-label="Simpan logo perusahaan" title="Simpan logo perusahaan"><Check size={18} /></button>
                  <button type="button" onClick={() => { setEditingKey(""); setDraft(""); }} className="grid h-11 w-11 place-items-center rounded-lg bg-slate-100 text-slate-500" aria-label="Batal edit logo perusahaan" title="Batal edit logo perusahaan"><X size={18} /></button>
                </div>
              ) : null}
            </div>
