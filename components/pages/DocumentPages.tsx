          ...
          <div className="grid gap-5 lg:grid-cols-2">
            ...
            <div className="block">
              <div className="mb-2 flex items-center gap-3">
                <button
                  ...
                  aria-label="Aktifkan atau nonaktifkan tanggal kedaluwarsa"
                  title="Aktifkan atau nonaktifkan tanggal kedaluwarsa"
                >
              ...
              {hasExpiredDate && (
                <input
                  ...
                  title="Tanggal kedaluwarsa dokumen"
                />
              )}
            </div>
            ...
            <div className="flex items-center gap-3 lg:col-span-2">
              <button
                ...
                aria-label="Aktifkan atau nonaktifkan dokumen milik mitra"
                title="Aktifkan atau nonaktifkan dokumen milik mitra"
              >
            ...
            <div className="lg:col-span-2">
              ...
              >
                <input
                  ...
                  className="hidden"
                  aria-label="Unggah berkas dokumen"
