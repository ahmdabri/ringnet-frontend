  ...
  return (
    <header className="sticky top-0 z-20 flex h-[72px] items-center justify-between border-b border-slate-200 bg-white/95 px-5 backdrop-blur lg:ml-[264px] lg:px-7">
      <div className="flex flex-1 items-center gap-4">
        <button onClick={() => setSidebarOpen?.(true)} aria-label="Buka sidebar" title="Buka sidebar" className="grid h-10 w-10 place-items-center rounded-lg border border-slate-200 text-slate-600 lg:hidden"><Menu size={20} /></button>
      ...
      <div className="flex items-center gap-4">
        <div ref={panelRef} className="relative">
          <button onClick={() => setOpen((current) => !current)} aria-label="Buka notifikasi" title="Buka notifikasi" className="relative grid h-10 w-10 place-items-center rounded-lg border border-slate-200 text-slate-600 transition hover:border-indigo-200 hover:text-indigo-600">
            <Bell size={18} />
            ...
            <div className="absolute right-0 top-[calc(100%+12px)] z-50 w-[min(92vw,760px)] overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-2xl shadow-slate-900/15">
              <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button onClick={() => setOpen(false)} aria-label="Tutup notifikasi" title="Tutup notifikasi" className="grid h-9 w-9 place-items-center rounded-lg border border-slate-200 text-slate-500 hover:text-slate-900"><X size={16} /></button>
                </div>
              </div>
